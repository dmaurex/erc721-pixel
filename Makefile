...
.PHONY: all test test-sepolia clean help install snapshot format anvil deployBasicNft deployActionNft mintBasicNft mintActionNft flipActionNft #deploy-sepolia 
